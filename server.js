...
db.serialize(() => {
  ...
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_preview_account', 'IMO Account Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_preview_password', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_preview_authentication', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_preview_number', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_preview_email', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_value_account', 'IMO Account Verified')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_value_password', 'Password Verified Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_value_authentication', 'Authentication Verified Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_value_number', 'Phone Verified Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('imo_demo_value_email', 'Email Verified Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_preview_account', 'TikTok Account Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_preview_password', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_preview_authentication', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_preview_number', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_preview_email', '••••••••••••')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_value_account', 'TikTok Account Verified')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_value_password', 'Password Verified Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_value_authentication', 'Authentication Verified Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_value_number', 'Phone Verified Demo')`);
  db.run(`INSERT OR IGNORE INTO site_settings (setting_key, setting_value) VALUES ('tiktok_demo_value_email', 'Email Verified Demo')`);
